...
// ✅ Price visibility helper: only show when > 0
const hasPrice = (price) => {
  const n = Number(price);
  return Number.isFinite(n) && n > 0;
};

// ✅ Delivery time visibility helper
const hasDeliveryTime = (t) => {
  if (t === null || t === undefined) return false;
  const s = String(t).trim();
  if (s === "") return false;
  const n = parseInt(s, 10);
  if (!Number.isNaN(n) && n <= 0) return false;
  return true; // show for positive numbers or non-empty strings like "Same day"
};
          ...
          {sponsoredItems.length > 0 && (
            <Box
              sx={{
                ...
                borderRadius: 1.5,
                background:
                  "linear-gradient(135deg, #FFFEF7 0%, #FFFDF5 50%, #FFFCF3 100%)",
              ...
              <Box
                ...
                onTouchMove={(e) => {
                  const startX = parseFloat(
                    e.currentTarget.dataset.dragStart || 0
                  );
                    ...
                    >
                      ...
                      <Box
                        sx={{
                          ...
                          color: "#fff",
                          background:
                            "linear-gradient(90deg, #FFD700, #FFC107, #FFD700)",
                      ...
                      >
                        ...
                        <Stack spacing={1.5}>
                          <Stack
                            ...
                            justifyContent="space-between"
                          >
                            {hasDeliveryTime(item.deliveryTime) && (
                              <Stack
                                direction="row"
                                alignItems="center"
                                spacing={0.5}
                          ...
                          <Button
                            ...
                            sx={{
                              ...
                              "&:hover": {
                                background:
                                  "linear-gradient(135deg,#FFA000,#FF6F00)",
